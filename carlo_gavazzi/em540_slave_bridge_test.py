...
from carlo_gavazzi.em540_slave_bridge import Em540Slave, REG_OFFSET
...
class TestEm540Slave(unittest.TestCase):
    ...
    def _build_slave(self, frame=None):
        ...
        with patch("carlo_gavazzi.em540_slave_bridge.ModbusTcpServer"), \
             patch("carlo_gavazzi.em540_slave_bridge.ModbusServerContext"), \
             patch("carlo_gavazzi.em540_slave_bridge.ModbusSparseDataBlock") as mock_block_cls:
